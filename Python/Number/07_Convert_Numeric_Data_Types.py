...
entero = 10
flot = 2.99
print('''Float -> Entero (eliminando float)''')
...
print(int(flot))
print('''-----''')
print('''Entero -> Float (poniendo float, entero.0)''')
...
print(float(entero))
print('''-----''')
print('''Float -> Decimal (poniendo decimales)''')
...
print(Decimal(flot))
print('''-----''')
print('''Float -> Cientifico (notación cientifica)''')
